 ...
 */
package de.hybris.myproject.storefront.filters;
...
/**
 * Filter that initializes the session for the myprojectb2bstorefront. This is a spring configured filter that is
